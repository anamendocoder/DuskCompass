 ...
 * This file demonstrates how to integrate Duskcompass with a web frontend
 */

// For React/Vue/Angular applications
export class DuskcompassClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DuskcompassClient(provider, contractAddress);
