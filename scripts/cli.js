...
const contractABI = require("../artifacts/contracts/Duskcompass.sol/Duskcompass.json").abi;

program
    .name("duskcompass-cli")
    .description("CLI tool for Duskcompass smart contract")
    .version("1.0.0");
